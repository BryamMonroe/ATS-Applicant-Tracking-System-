/**
 * Toast — notificações temporárias de sucesso/erro.
 *
 * Uso simples: <Toast mensagem="Candidato salvo!" tipo="sucesso" onFechar={...} />
...
export function Toast({ mensagem, tipo = 'sucesso', onFechar }) {
  ...
  return (
    <div className={`fixed bottom-5 right-5 z-[100] flex items-center gap-2.5
