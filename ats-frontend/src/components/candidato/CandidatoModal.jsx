      ...
      <div className="card w-full max-w-lg max-h-[90vh] flex flex-col shadow-modal">
        ...
        <div className="flex-1 overflow-y-auto px-5 py-4 space-y-4">
          ...
          <div>
            ...
            <input
              className={`field ${erros.nome ? "border-red-300 focus:ring-red-200" : ""}`}
          ...
          <div>
            ...
            <input
              className={`field ${erros.email ? "border-red-300" : ""}`}
              type="email"
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <input
                className={`field ${erros.cargoDesejado ? "border-red-300" : ""}`}
                placeholder="Backend Developer"
                value={form.cargoDesejado}
                onChange={set("cargoDesejado")}
              />
              {erros.cargoDesejado && (
          ...
          <div>
            ...
            {edicao && candidato.temCurriculo && !arquivo && (
              <div
                className="flex items-center gap-2 p-2.5 rounded-lg bg-stone-50
            ...
            {arquivo && (
              <div
                className="flex items-center gap-2 p-2.5 rounded-lg bg-accent-50
                              border border-accent-200 mb-2"
              >
                <FileText size={14} className="text-accent-500" />
                <span className="text-sm text-accent-700 truncate flex-1">
                  {arquivo.name}
                </span>
                ...
                <button
                  ...
                  className="text-accent-400 hover:text-accent-700 p-1"
                >
                  <X size={13} />
                </button>
              </div>
            ...
            />
            {erros.arquivo && (
              <p className="text-xs text-red-500 mt-1">{erros.arquivo}</p>
            )}
          </div>
        </div>
